...
const Header = ({ cartItems, setCartItems,isUserLoggedIn,setIsUserLoggedIn}) => {
                    ...
                    <div className="mobile">
                        ...
                        <div className="mobile-main">
                            ...
                            <Link to={"/cart/guest"} className="cart">
                                <i className="fas fa-cart-plus"></i>
                                <span>{Object.keys(guestCart).length}</span>                                </Link>
                        </div>
                        ...
                        {isMobile && (
                            <div className="mobile-menu">
                                ...
                                <Link to={"/login"} className="" onClick={() => setIsMobile(false)}>Login</Link>
                                <Link to={"/signup"} className="" onClick={() => setIsMobile(false)}>SignUp</Link>
